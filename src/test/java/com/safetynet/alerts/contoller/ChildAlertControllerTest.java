...
@ContextConfiguration(classes = {ChildAlertController.class, PersonService.class})
@WebMvcTest
public class ChildAlertControllerTest {
    ...
    public void givenAddress_whenFindPersonsByAddress_thenReturnListOfChildrenAdult_Test()
        ...
        given(personService.findPersonsByAddress(anyString())).willReturn(ConstantsTest.personsWithBirthDate);
    ...
    public void givenAddress_whenFindPersonsByAddress_thenReturnNoChildrenFound_Test()
        ...
        given(personService.findPersonsByAddress(anyString())).willReturn(ConstantsTest.personsWithBirthDateNoChildren);
